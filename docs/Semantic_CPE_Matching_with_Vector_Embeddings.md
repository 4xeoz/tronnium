...
Parse the user's input — extract vendor, product, version using regex and a hardcoded list of known vendor names
Search NVD's API with that extracted text as a keyword query
Rank the returned candidates using a weighted scoring formula
